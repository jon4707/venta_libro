...
public class VentasService {
    ...
    private static final String INVENTARIO_URL = "http://localhost:8083/api";
    ...
    private void registrarUnidadesVendidas(Ventas venta) {
        for (Cantidad c : venta.getProductos()) {
            try {
                ...
                System.err.println("Error al registrar unidades vendidas del libro " + c.getIdLibro() + ": " + e.getMessage());
            }
        }
    }
}
